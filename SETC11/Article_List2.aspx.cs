...
public partial class Article_List2 : System.Web.UI.Page
{
    ...
    {       
        using (SqlConnection conn = new DB().GetConnection())
        {
            ...
            string CatID = "0";
            cmd.CommandText = "Select ID,CatName,Description From Cats Where ID = ( Select CatID From Subs Where ID = " + ViewState["SubID"] + " )";
            conn.Open();
    ...
    private void MyDataBind()
    {
        ...
        string whereStr = " where SubID = " + ViewState["SubID"] + " and Status = 1 and Finished = 1 ";
